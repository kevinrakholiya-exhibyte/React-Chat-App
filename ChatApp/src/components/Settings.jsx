...
import { Moon, Sun, Bell, Lock, MessageCircle, HelpCircle, LogOut, Settings as SettingsIcon, ArrowLeft } from 'lucide-react'
        ...
        <div className="min-h-screen bg-white dark:bg-gray-900">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-blue-100 dark:text-gray-300 text-sm">Manage your preferences</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto p-4 sm:p-6">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 sm:p-6 mb-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div
                            ...
                            className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${theme === "light"
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-500 dark:text-gray-400">Bright and clear</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${theme === "dark"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <button className="bg-red-500 hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700 text-white font-bold py-3 px-6 rounded-xl transition flex items-center justify-center gap-2 shadow-md">
